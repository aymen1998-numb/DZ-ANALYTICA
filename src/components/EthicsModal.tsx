...
import { X, ShieldCheck, Check, Lock, Eye } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-5 rounded-2xl bg-white/5 border border-white/10 mb-8">
              <p className="text-gray-300 text-sm leading-relaxed text-right font-sans">
            ...
            <div className="space-y-6 mb-8 text-right">
              {/* Principle 1 */}
              <div>
                <h4 className="flex items-center justify-start gap-2 font-bold text-dz-gold text-lg mb-2">
