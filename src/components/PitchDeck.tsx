...
const slides = [
      ...
      <div className="flex flex-col items-center justify-center h-full space-y-8 text-center pt-10">
        ...
        <div>
          ...
          <p className="text-2xl md:text-3xl text-gray-300 font-light">
            البناء العلمي للحملات السياسية
          </p>
        </div>
      </div>
    ),
  ...
  },
  {
    id: "problem",
    title: "المشكلة",
    subtitle: "لماذا تفشل الحملات الانتخابية التقليدية؟",
    content: (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        {[
          ...
          },
          {
            ...
            desc: "عدم فهم الدوافع النفسية والسيكومترية للناخبين يؤدي لرسائل سياسية غير مطابقة لتطلعاتهم.",
          },
          {
            icon: PieChart,
            title: "نقص البيانات",
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                دمج القوائم الانتخابية، الردود الاستبيانية، والتفاعلات الرقمية
                في قاعدة موحدة ومجهولة الهوية لتكوين صورة دقيقة للناخب.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                استخدام أدوات مسح حديثة مثل اختبارات البوصلة السياسية لفهم
                وتصنيف توجهات المجتمع.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                استخراج الخرائط التفاعلية وتوجيه جهود الحملة الانتخابية و
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12 items-center">
        ...
        <div className="space-y-6">
          <p className="text-xl leading-relaxed text-gray-300 drop-shadow-md border-r-4 border-dz-gold pr-6 rounded-r-sm">
            يُعتبر DZ Compass واجهة جذابة للمستخدمين لفهم موقعهم السياسي، وهو في
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg">
                استيعاب التفضيلات السياسية والاقتصادية.
              </span>
            </li>
            <li className="flex items-center gap-3">
              <CheckCircle2 className="w-5 h-5 text-dz-green" />
              <span className="text-lg">
                قياس نوايا التصويت و الانتماء للأحزاب.
              </span>
            </li>
            <li className="flex items-center gap-3">
              <CheckCircle2 className="w-5 h-5 text-dz-green" />
  ...
  },
  {
    ...
    subtitle: "بيئة مهيأة للابتكار السياسي في الجزائر ومنطقة الـ MENA",
    content: (
        ...
        {[
          {
            title: "الناخبون",
            value: "24.5M+",
            desc: "حجم الهيئة الناخبة في الجزائر",
            icon: Users,
          },
          {
            title: "الأحزاب",
            value: "60+",
            desc: "أحزاب سياسية معتمدة تبحث عن طرق مبتكرة للتواصل",
            icon: Target,
          },
          {
            title: "مرشحين مستقلين",
            value: "الآلاف",
            desc: "مرشحون للانتخابات التشريعية والمحلية والرئاسية",
            icon: LineChart,
          },
          {
            title: "الاستهداف",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        <div className="bg-white/5 border border-dz-gold/30 rounded-2xl p-8 relative">
          ...
          <h3 className="text-2xl font-bold mb-4">
            العقود السياسية والاستشارية
          </h3>
          <p className="text-gray-400 leading-relaxed">
            شراكات مباشرة B2B و B2G مع الأحزاب ومكاتب الحملات لتقديم التحليلات
            التنبؤية والتوجيه الميداني خلال فترات الانتخابات.
          </p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 relative">
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            لاختبار الرسائل التسويقية (خارج فترات الانتخابات).
          </p>
        </div>
      </div>
    ),
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl text-right">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h4 className="text-xl font-bold">
                تطوير نماذج ذكاء اصطناعي سياسية مخصصة
              </h4>
            </div>
            <p className="text-gray-400">
              بناء LLMs مدربة خصيصاً على السرديات السياسية والثقافية الجزائرية
